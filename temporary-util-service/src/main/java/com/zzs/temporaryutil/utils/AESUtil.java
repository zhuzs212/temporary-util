 ...
 * @author 王学明
 * aes 128位 cbc 算法
 * HTML 的 &lt;&gt;&amp;&quot;&copy;&nbsp; 分别是<，>，&，"，©;空格的转义字符
 */
@Slf4j
public class AESUtil {

	// 加密 1234567890123456 skBzQkhwi2ZJueAC
	public static String Encrypt(String sSrc, String sKey){
		return Encrypt(sSrc, sKey, "skBzQkhwi2ZJueAC");//默认向量
	}

	public static String Encrypt(String sSrc, String sKey, String ivStr){
		String enc="";
		try {
			enc=EncryptWithException(sSrc, sKey, ivStr);
		} catch (Exception e) {
	...
	// 加密
	public static String EncryptWithException(String sSrc, String sKey, String ivStr)
			throws Exception {
		if (sKey == null) {
			log.error("Key为空null");
			return null;
	...
	public static String Decrypt(String sSrc, String sKey) throws Exception {
		return Decrypt(sSrc, sKey, "9sdc4XWo7g5h78UD");
	}
	...
	/*
	 * escapeChar 字符转换 加密前分别把<，>，&，"，© 的转义字符 转换成 &lt; &gt;&amp;&quot;&copy;
	 * 
	 * 
	 * private static String escapeChar(String beforeEncryptString ){ String
	 * escapeStr=beforeEncryptString; escapeStr=escapeStr.replaceAll("<",
	 ...
	 */
	/*
	 * unEscapeChar 反向字符转换 解密后分别把&lt; &gt;&amp;&quot;&copy; 的转义字符 转换成 <，>，&，"，©
	 * 
	 * 
	 * private static String unEscapeChar(String beforeDecryptString ){ String
	 * unEscapeStr=beforeDecryptString; unEscapeStr=unEscapeStr.replaceAll(
